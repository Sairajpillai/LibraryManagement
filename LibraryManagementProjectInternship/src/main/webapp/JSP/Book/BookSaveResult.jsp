...
<div class="header">
    ...
    <div class="navbar-links">
        ...
        <a href="../HTML/Librarian/AddLibrarian.html">Add Book</a>
        <a href="../HTML/Librarian/EditLibrarian.html">Edit Book</a>
        <a href="../HTML/Librarian/FindLibrarian.html">Find Book</a>
        <a href="../HTML/Librarian/DeleteForm.html">Delete Book</a>
    </div>
</div>
<div class="container">
<c:choose>
		<c:when test="${loginResult eq 'success' }">
			<c:choose>
				<c:when test="${message eq 'success' }">
					<h1 class="success-heading">Book Successfully Added</h1>
				</c:when>
				<c:otherwise>

					<h1 class="failure-heading">Book Registration Failed</h1>
				</c:otherwise>
			</c:choose>
		</c:when>
		<c:otherwise>
